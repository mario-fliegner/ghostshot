...
| Block 9 | Flash Video Mode + Branding-Timing-Modell | **Completed** | 2026-06-17 | `VideoMode.FLASH`, `FlashRenderEngine`, Pipeline-Erweiterung (3 when-Zweige), Label-Änderung "Compare Slider"→"Compare" (EN+DE), Branding-Timing-Modell (animationFrameCount = selectedDuration immer); T-F-U-01–T-F-U-09 + T-F-I-01–T-F-I-02; `testDebugUnitTest` PASSED; assembleDebug + assembleRelease BUILD SUCCESSFUL |
| Block 9b | Video Type Selector UX Polish | **Completed** | 2026-06-17 | `SameViewSegmentItem` um optionales `icon: ImageVector?` erweitert; `SameViewSegmentControl` rendert Icon + 4dp + Label wenn icon != null; Icons: CompareArrows / Timeline / FlashOn; `create_video_branding_hint` entfernt (EN + DE); `testDebugUnitTest` PASSED; assembleDebug + assembleRelease BUILD SUCCESSFUL |
| Block 9c | Branding Default OFF + labelMedium Icon-Modus | **Completed** | 2026-06-17 | `SettingsRepository.kt`: `?: true` → `?: false` (Branding Default OFF); `SettingsComponents.kt`: icon != null Zweig: `labelLarge` → `labelMedium`; FD-15 in VIDEO_EXPORT_V1.md aktualisiert; `testDebugUnitTest` PASSED; assembleDebug + assembleRelease BUILD SUCCESSFUL |
| Block 9d | Video Mode Label Rename + Icon Revert | **Completed** | 2026-06-17 | UI-Labels: "Compare"→"Slider", "Before & After"→"Fade", "Flash" unverändert (EN + DE); Icons aus modeItems entfernt; icon-Imports entfernt; `labelMedium` zurück auf `labelLarge`; alle Segment-Controls wieder vereinheitlicht; Dokumentation aktualisiert; `testDebugUnitTest` PASSED; assembleDebug + assembleRelease BUILD SUCCESSFUL |
